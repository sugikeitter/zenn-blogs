...
|Lv.|タイトル|動画URL|備考|
|---|---|---|---|
|`100`| [ASCII.jp：なぜAmazonはマイクロサービスに舵を切ったのか？](https://ascii.jp/elem/000/001/620/1620756/)| -| Amazon.com のシステムがモノリシックアーキテクチャのアンチパターンにハマってしまい、ビジネスの急成長にシステムのスケールや機能追加が追いつかなり、マイクロサービスに大きく方向転換した背景。AWS の歴史の話もちょこっと。|
